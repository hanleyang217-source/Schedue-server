...
//--------------------------------------普通日程普通日程普通日程普通日程普通日程--------------------------------------------------------------------
    ...
    public Result add(@RequestBody @Validated AddSchedueRequest request) {
        ...
        schedue.setRole(0);
        schedue.setContext(request.getDetail());
    ...
    public Result single(@RequestBody Map<String, Integer> params) {
        ...
        ReturnSchedue RS = new ReturnSchedue();
        RS.setId(schedue.getId());
        RS.setSchedueName(schedue.getSchedueName());
        RS.setRole(schedue.getRole());
        RS.setStartTime(schedue.getStartTime());
        RS.setEndTime(schedue.getEndTime());
        RS.setAddress(schedue.getAddress());
        if(schedue.getTeacherName() == null)
        {
            RS.setDetail("详情" + schedue.getContext());
        }
        else {
            RS.setDetail("相关人员:" + schedue.getTeacherName() + "详情" + schedue.getContext());
        }
