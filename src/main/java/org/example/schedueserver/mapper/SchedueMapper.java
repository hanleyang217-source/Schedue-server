...
public interface SchedueMapper {
    ...
    //添加日程
    @Insert("insert into schedue(schedue_name , creater_id , role , address , teacher_name , create_time , update_time , start_time , end_time , context)" +
            " values (#{schedueName} , #{createrId} , #{role} , #{address} , #{teacherName} , #{createTime} , #{updateTime} , #{startTime} , #{endTime} , #{context})")
